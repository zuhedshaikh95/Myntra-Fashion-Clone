let DealOfDay =[
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/ae878fb2-e09d-4981-bbe2-e4261cca96261658318330166-minimalist.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/68cc423a-edb0-4dcc-b93b-a3cd7a396a481658311519338-Kurtas---Sets--4-.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/6f7e9c5d-7d5f-4564-b946-eaed73c3c1c91658311519330-Best-Of-Western-Wear--9-.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/c4a512dd-3f41-4125-bbe9-b5b546c7ccf91658311519322-Western-Wear--18-.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/e948fc00-bfe2-4521-9924-e13cffcf60d11658311519315-Jewellery--18-.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/1faf5fd5-1145-4a00-97e2-8901e89c81b21658311519306-Casual-Footwear--1-.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/78e4127b-ab19-4c21-b08e-b750aef944df1658311519298-Titan.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/7c5796ac-121a-4309-ac3f-7ba4eb3a8a0e1658311519288-Footwear--10-.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/dcc72af4-db5a-4f24-bcba-5460c959b8f21658311519280-Shorts--3-.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_98,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/20/acf4b083-d77c-4d2e-b547-6033b13d66841658318330174-armani.jpg"
    }
];
let DoD = document.querySelector(".deal-of-day");
DealOfDay.forEach((elem,index)=>{
...
let ExclusiveBrands = [
    {
        img:"https://assets.myntassets.com/f_webp,w_122,c_limit,fl_progressive,dpr_2.0/assets/images/retaillabs/2022/3/10/b25f89eb-fbeb-4013-829e-32ee5b5daaa01646895183668-Roadster-HRX_Unisex.jpghttps://assets.myntassets.com/f_webp,w_122,c_limit,fl_progressive,dpr_2.0/assets/images/retaillabs/2022/3/10/b25f89eb-fbeb-4013-829e-32ee5b5daaa01646895183668-Roadster-HRX_Unisex.jpg"
    },
    {
...
let exclusiveCont = document.querySelector(".exclusive-brands");
ExclusiveBrands.forEach((elem,index)=>{
    let img = document.createElement("img");
    img.setAttribute("src",elem.img);
    exclusiveCont.append(img);
});
...
let topPicksCont = document.querySelector(".top-picks");
TopPicks.forEach((elem,index)=>{
    let img = document.createElement("img");
    img.setAttribute("src",elem.img);
    topPicksCont.append(img);
});
...
CategoryBag.forEach((elem,index)=>{
    let img = document.createElement("img");
    img.setAttribute("src",elem.img);
...
let dealsBrandCont = document.querySelector(".deals-top-brands");
DealsTopBrands.forEach((elem,index)=>{
    let img = document.createElement("img");
    img.setAttribute("src",elem.img);
    dealsBrandCont.append(img);
});
...
let slashedCont = document.querySelector(".slashed-prices");
slashedPrices.forEach((elem,index)=>{
    let img = document.createElement("img");
    img.setAttribute("src",elem.img);
    slashedCont.append(img);
});
...
let besyBuyCont = document.querySelector(".best-buys");
BestBuys.forEach((elem,index)=>{
    let img = document.createElement("img");
    img.setAttribute("src",elem.img);
    besyBuyCont.append(img);
});
...
let luxuryBrands = [
    ...
    {
        img:"https://assets.myntassets.com/f_webp,w_83,c_limit,fl_progressive,dpr_2.0/assets/images/2021/6/17/4fac3c61-9e54-486c-a083-6f61df81436c1623933299972-HPCarouselVisibility-MyntraLuxe-Tissot.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_83,c_limit,fl_progressive,dpr_2.0/assets/images/2021/11/12/65d5107e-35cf-4176-aef3-b7ae77dd09761636726166252-HP-FredPerry.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_83,c_limit,fl_progressive,dpr_2.0/assets/images/2021/6/17/9b04f96a-f1ed-4edc-8840-483719055fdb1623940080549-HPCarouselVisibility-MyntraLuxe-ExploreStore.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_83,c_limit,fl_progressive,dpr_2.0/assets/images/2021/11/12/6eaf8591-e92b-4ab3-a4e5-f38caac6c7d91636726166295-HP-POLORalphLauren.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_83,c_limit,fl_progressive,dpr_2.0/assets/images/2021/6/17/adf54639-1714-4935-8d22-ceef8ef1d8d31623940080665-HPCarouselVisibility-TheCollective-ExploreStore.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_83,c_limit,fl_progressive,dpr_2.0/assets/images/2021/11/12/7e273a5a-9372-4956-af96-38aa903668201636726166272-HP-KarlLagerfeld.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_83,c_limit,fl_progressive,dpr_2.0/assets/images/2021/6/17/bfa35f05-88b3-419f-af88-83c2ea0483f91623933299966-HPCarouselVisibility-MyntraLuxe-Tedbaker.jpg"
    },
    {
        img:"https://assets.myntassets.com/f_webp,w_83,c_limit,fl_progressive,dpr_2.0/assets/images/2021/11/12/884c0181-9da3-43c4-89f5-8696b97ec7751636726166246-HP-Dyson.jpg"
    },
];
let luxuryCont = document.querySelector(".luxury-brands");
luxuryBrands.forEach((elem,index)=>{
    let img = document.createElement("img");
    img.setAttribute("src",elem.img);
    luxuryCont.append(img);
});
